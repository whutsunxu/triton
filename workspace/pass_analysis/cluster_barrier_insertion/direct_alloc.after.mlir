...
module attributes {"ttg.num-ctas" = 2 : i32, "ttg.num-warps" = 4 : i32, ttg.shared = 16392 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
  tt.func @case_direct_alloc_reuse(%arg0: !tt.tensordesc<64x128xf16, #shared>, %arg1: tensor<64x128xf16, #blocked>) {
    ...
    ttng.async_tma_copy_global_to_local %arg0[%c0_i32, %c0_i32] %1, %0, %true {multicast} : !tt.tensordesc<64x128xf16, #shared>, !ttg.memdesc<2xi64, #shared1, #smem, mutable> -> !ttg.memdesc<64x128xf16, #shared, #smem, mutable>
    ttng.wait_barrier %0, %c0_i32 deps %1 : !ttg.memdesc<2xi64, #shared1, #smem, mutable>, !ttg.memdesc<64x128xf16, #shared, #smem, mutable>
    ttg.local_dealloc %1 : !ttg.memdesc<64x128xf16, #shared, #smem, mutable>
    %2 = ttg.local_alloc {allocation.offset = 0 : i32} : () -> !ttg.memdesc<64x128xf16, #shared, #smem, mutable>
    ttng.cluster_barrier
    ttg.local_store %arg1, %2 : tensor<64x128xf16, #blocked> -> !ttg.memdesc<64x128xf16, #shared, #smem, mutable>
    ttg.local_dealloc %2 : !ttg.memdesc<64x128xf16, #shared, #smem, mutable>
